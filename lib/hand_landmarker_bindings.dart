...
/// from: `com.example.flutter_mediapipe_hand_tracking.MyHandLandmarker`
class MyHandLandmarker extends jni$_.JObject {
  ...
  static final _class = jni$_.JClass.forName(
    r'com/example/flutter_mediapipe_hand_tracking/MyHandLandmarker',
  );
  ...
  factory MyHandLandmarker(jni$_.JObject context) {
    ...
    return MyHandLandmarker.fromReference(
      _new$(
  ...
  static final _id_initialize = _class.instanceMethodId(r'initialize', r'()V');
  ...
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JString detect(jni$_.JByteBuffer byteBuffer, int i, int i1, int i2) {
    final _$byteBuffer = byteBuffer.reference;
    return _detect(
      reference.pointer,
      _id_detect as jni$_.JMethodIDPtr,
...
final class $MyHandLandmarker$NullableType
  ...
  String get signature =>
      r'Lcom/example/flutter_mediapipe_hand_tracking/MyHandLandmarker;';

  @jni$_.internal
  @core$_.override
  MyHandLandmarker? fromReference(jni$_.JReference reference) =>
      reference.isNull ? null : MyHandLandmarker.fromReference(reference);
  @jni$_.internal
  @core$_.override
...
final class $MyHandLandmarker$Type extends jni$_.JObjType<MyHandLandmarker> {
  ...
  @core$_.override
  MyHandLandmarker fromReference(jni$_.JReference reference) =>
      MyHandLandmarker.fromReference(reference);
  @jni$_.internal
  @core$_.override
  jni$_.JObjType get superType => const jni$_.JObjectType();
